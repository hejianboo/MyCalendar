...
public final class ChineseCalendar extends GregorianCalendar {
    ...
    public String getFullChineseDateString() {
        return new StringBuffer().append(getChinese(CHINESE_YEAR)).append("年")
                .append(getChinese(CHINESE_MONTH)).append("月")
    ...
    public String getChineseMonthString() {
        return new StringBuffer()
                .append(getChinese(CHINESE_MONTH)).append("月").toString();
    }
    ...
    public String toString() {
        ...
        buf.append(getSimpleGregorianDateString()).append(" | ")
                ...
                .append(getChinese(CHINESE_ANIMAL)).append("年 ")
