...
//            SharedPreferences prefs = getSharedPreferences(context, prefsName);
    ...
    public static class TimeZoneUtils {
         ...
         *                    {@link android.text.format.DateUtils#formatDateRange(android.content.Context,
         ...
         * {@link android.provider.CalendarContract.CalendarCache#TIMEZONE_TYPE_AUTO} will cause it
         * to be set
        ...
        private class AsyncTZHandler extends AsyncQueryHandler {
            ...
            protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
                synchronized (mTZCallbacks) {
                    ...
                    cursor.close();
                    if (writePrefs) {
                        SharedPreferences prefs = getSharedPreferences((Context) cookie,
                                mPrefsName);
                        // Write the prefs
                        setSharedPreference(prefs, KEY_HOME_TZ_ENABLED, mUseHomeTZ);
                        setSharedPreference(prefs, KEY_HOME_TZ, mHomeTZ);
