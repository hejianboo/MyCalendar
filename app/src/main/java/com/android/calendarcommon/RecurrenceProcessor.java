...
public class RecurrenceProcessor {
     ...
     *                            {@link android.text.format.Time} should be in the timezone of the
     *                            event.
        ...
        try {
            ...
            events:
            {
                while (true) {
                    int monthIndex = 0;
                    if (failsafe++
                            > MAX_ALLOWED_ITERATIONS) { // Give up after about 1 second of processing
